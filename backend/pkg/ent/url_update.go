...
func (uu *URLUpdate) SetShortID(s string) *URLUpdate {
	uu.mutation.SetShortID(s)
	return uu
}
...
func (uu *URLUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.ShortID(); ok {
...
// SetShortID sets the "short_id" field.
func (uuo *URLUpdateOne) SetShortID(s string) *URLUpdateOne {
	uuo.mutation.SetShortID(s)
	return uuo
}
...
func (uuo *URLUpdateOne) sqlSave(ctx context.Context) (_node *Url, err error) {
	...
	if value, ok := uuo.mutation.ShortID(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: url.FieldShortID,
